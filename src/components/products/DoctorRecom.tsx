        ...
        <section className="relative py-32 overflow-hidden ">
            <section className=" font-sans text-slate-900 dark:text-white transition-colors duration-300 py-8">
                <div className="container w-full px-6 flex flex-col gap-6 mx-auto">
                    ...
                    {/* Content */}
                    {/* <div className="relative  container z-30  mx-auto px-12  h-full w-full bg-gradient-to-r from-[#131313]/95 via-[#131313]/70 to-transparent"> */}
                    <div className=" container">

                        {/* Title */}
                        {/* <FadeIn direction="up" duration={0.8}>
                        <h1 className="text-5xl md:text-5xl font-bold tracking-tight text-white leading-none mb-0">
                          
                            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-300 pb-1">
                               Holistic Benefits
                            </span>
                        </h1>
                    </FadeIn> */}
                        <div className="relative flex gap-20 justify-between w-full  py-1  px-6 md:px-2 ">
                                ...
                                <div className="max-w-4xl mx-auto relative w-full">
                                    ...
                                    >
                                        <p className="text-xl md:text-2xl lg:text-xl font-bold italic leading-relaxed text-gray-200 text-center tracking-wide">
                                            "{product.doctorRecom?.quote || "Product is scientifically formulated to support optimal growth and health."}"
                                        </p>
                                    </motion.div>
                                    ...
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                        className="absolute -bottom-12 right-3 font-bold"
                                    >
                                        - {product.doctorRecom?.doctorName || "Doctor"}
                            ...
                            <section>
                                <img
                                    src={product.doctorRecom?.image || "/p1doc5.png"}
                                    className="w-[400px] "
                                    alt={`Doctor recommending ${product.name}`}
                                />
                            </section>
                        </div>
                    </div>
