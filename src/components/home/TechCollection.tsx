...
export function TechCollection() {
    ...
    return (
        <div className="relative right-[70px] flex h-screen w-full flex-col overflow-hidden ">
            ...
            <main className="flex-grow left-24 flex flex-col relative items-center justify-center w-full h-full ">
                ...
                <div className="relative z-10 w-full max-w-[1400px] h-full flex flex-col md:flex-row items-center justify-center md:justify-between px-6 md:px-20 pt-20 pb-28 md:pb-20">
                    ...
                    <div className="order-1 md:order-2 flex-1 relative flex  flex-col  justify-center h-[50vh] md:h-auto w-full">
                        ...
                        <div className=' flex items-center justify-center '>
                            ...
                            >
                                <div
                                    className="w-[80%] md:w-[500px] aspect-square bg-contain bg-center bg-no-repeat drop-shadow-2xl"
                    ...
                    <div className="order-2 md:order-1 flex flex-col gap-6 md:gap-8 max-w-md animate-fade-in-up z-20">
                        <div className="space-y-2">
                            <span className="inline-block px-3 mb-8 py-1 rounded-full bg-[#25aff4]/10 text-[#25aff4] text-xs font-bold tracking-widest uppercase border border-[#25aff4]/20">
                            ...
                            <AnimatePresence mode='wait'>
                                <motion.div
                                    ...
                                    transition={{ duration: 0.5 }}
                                >
                                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white tracking-tighter leading-tight uppercase mb-4"
                                        onMouseEnter={() => setIsPaused(true)}
                                        onMouseLeave={() => setIsPaused(false)}
                                    >
                       ...
                       <motion.div
                        ...
                        {/* {product catagory} */}
                        <motion.div
                            className="flex flex-col sm:flex-row gap-4 bg-[#0f1720]/80 backdrop-blur-2xl p-3 rounded-2xl border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] w-full sm:w-auto lg:w-[520px] relative z-20 mt-[47px] overflow-hidden"
