...
export function AnimalImpact() {
    return (
        <section className="py-24 px-6 bg-[#213030]">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <FadeIn direction="left" className="order-1 md:order-2">
                    ...
                    <p className="text-lg text-gray-300 leading-relaxed mb-8">
                        We revolutionize animal feed with algae-derived proteins and probiotics that improve growth rates, disease resistance, and feed conversion ratios, all while reducing the environmental footprint of farming.
                    </p>
